  ...
  \begin{table}[H]
    \centering
      \begin{tabular}{| m{5em} | m{10cm} |}
        ...
        Objetivo & Aqui serão apresentados os componentes desenvolvidos e caso haja uma próxima iteração, será preparado o ambiente para a mesma.  \\ \hline
    ...
    \begin{table}[H]
      \centering
        \begin{tabular}{| m{5em} | m{10cm} |}
          ...
          Objetivo & Items do Backlog do Time serão testados internamente.   \\ \hline
          Entradas & Backlog do Time (Refinado)\\ \hline
...
\begin{table}[H]
  \centering
    \begin{tabular}{| m{5em} | m{10cm} |}
      ...
      Objetivo & Rastrar a necessidade de algum tipo de mudança, e caso haja documenta-las para serem analisadas na próxima atividade.  \\ \hline
...
\begin{table}[H]
  \centering
    \begin{tabular}{| m{5em} | m{10cm} |}
      ...
      Objetivo & Caso haja mudança nos requisitos do sistema, a atividade será acionada para analisar qual o impacto, e aprovar caso seja viável.  \\ \hline
